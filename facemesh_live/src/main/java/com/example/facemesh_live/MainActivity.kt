package com.example.facemesh_live
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        ...
        if (checkSelfPermission(Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
            faceMesh = FaceMesh(this@MainActivity,
                ...
                .apply {
                    ...
                    glSurfaceView = SolutionGlSurfaceView<FaceMeshResult>(this@MainActivity, this.glContext, this.glMajorVersion)
    ...
    private val renderer = object : ResultGlRenderer<FaceMeshResult> {
        ...
        override fun renderResult(result: FaceMeshResult?, projectionMatrix: FloatArray?) {
            ...
            for (face in result.multiFaceLandmarks()!!) {
                var points = FloatArray(FaceMesh.FACEMESH_NUM_LANDMARKS_WITH_IRISES * 2)
                for (i in 0 until FaceMesh.FACEMESH_NUM_LANDMARKS_WITH_IRISES) {
                    points[2 * i] = face.getLandmark(i).x
                    points[2 * i + 1] = face.getLandmark(i).y
                }
                ...
                GLES20.glDrawArrays(GLES20.GL_POINTS, 0, FaceMesh.FACEMESH_NUM_LANDMARKS_WITH_IRISES)
